...
/**
 * A base class used for all classes providing entity manipulation functionality.
 * 
 * @author boto
 ...
 */
public abstract class EntityAccess<T> {

    private final Class<T> entityClass;

    /**
     * Create the base for given entity class.
     * 
     * @param entityClass The entity class which is manipulated by this base class
     */
    public EntityAccess(Class<T> entityClass) {
