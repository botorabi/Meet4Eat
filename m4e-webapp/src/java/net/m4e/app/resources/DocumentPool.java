...
public class DocumentPool {
     ...
     */
    public DocumentPool(EntityManager entityManager, UserTransaction userTransaction) {
     ...
     * @throws Exception Throws an exception if the document is not valid.
     */
    public boolean releasePoolDocument(DocumentEntity document) throws Exception {
    ...
    private DocumentEntity createDocument() {
        ...
        try {
            ...
            Log.warning(TAG, "Could not create document, reason: " + ex.getLocalizedMessage());
            return null;
        }
        return document;
    }
     ...
     * @throws Exception    Throws an exception if the document is not valid.
     */
    private DocumentEntity findPoolDocument(String etag) throws Exception {
        EntityUtils eutils = new EntityUtils(entityManager, userTransaction);
