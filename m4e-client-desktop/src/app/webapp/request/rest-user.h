...
class RESTUser : public Meet4EatREST
{
    ...
    public:
        ...
        /**
         * @brief Update the user data. The results are emitted by signal 'onRESTUserUpdateData'.
         *
         ...
         */
        void                    updateUserData( const QString& userId, const QString& name, const QString& password, doc::ModelDocumentPtr photo );
    ...
    signals:
        ...
        /**
         * @brief Emit the results of updateUserData request.
         *
         * @param userId    ID of user who was updated
         */
