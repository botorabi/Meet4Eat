...
class UserAuthenticationRestServiceTest {
    ...
    private final static LoginCmd  INVALID_CREDENTIALS = new LoginCmd("", clientSideHash("", "salt"));
    ...
    void login_invalidInput() {
        Assertions.assertThat(userAuthentication.login(INVALID_CREDENTIALS, request).getCode()).isEqualTo(GenericResponseResult.CODE_BAD_REQUEST);
    }
